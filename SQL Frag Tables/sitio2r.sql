...
CREATE TABLE "scc2-edgecfd".oedgecfdpre2 AS
  SELECT dlmat.visc,mat.* FROM "scc2-edgecfd".oedgecfdpre AS mat INNER JOIN "scc2-edgecfd".dl_mat2 AS dlmat ON mat.dl_matid=dlmat.rid;

CREATE TABLE "scc2-edgecfd".oedgecfdpre4 AS
  SELECT dlmat.visc,mat.* FROM "scc2-edgecfd".oedgecfdpre AS mat INNER JOIN "scc2-edgecfd".dl_mat4 AS dlmat ON mat.dl_matid=dlmat.rid;
